...
try:
    import features.summarization.summarization
    ...
    from JarvisAI.JarvisAI.features.summarization import summarization
    from JarvisAI.JarvisAI.features.weather import weather as wea
    from JarvisAI.JarvisAI.features.website_open import website_open
    from JarvisAI.JarvisAI.features.send_mail import send_mail
    from JarvisAI.JarvisAI.features.date_time import date_time
    from JarvisAI.JarvisAI.features.launch_app import launch_app
    from JarvisAI.JarvisAI.features.news import news as nw
    from JarvisAI.JarvisAI.features.tell_me_about import tell_me_about as tma
    from JarvisAI.JarvisAI.features.face_recognition import dataset_create as dc
    from JarvisAI.JarvisAI.features.face_recognition import train as train
    from JarvisAI.JarvisAI.features.face_recognition import predict as predict
    from JarvisAI.JarvisAI.features.face_recognition import face_reco as fr
    from JarvisAI.JarvisAI.features.show_me_my_images import show_me_my_images as my_photos
    from JarvisAI.JarvisAI.features.setup import setup as setup_assistant
    from JarvisAI.JarvisAI.features.google_photos import google_photos as gp
    from JarvisAI.JarvisAI.features.joke import joke
    from JarvisAI.JarvisAI.features.hot_word_detection import hot_word_detection as wake_word
    from JarvisAI.JarvisAI.features.mic_input_ai.mic_input_ai import SpeechRecognition as SpeechRecognitionAI
...
class JarvisAssistant:
    ...
    def summarization(self, num):
        return summarization.summarization(num)
    ...
    def mic_sum_input(self, lang='en'):
        config = configparser.ConfigParser()
        config.read('config/config.ini')
