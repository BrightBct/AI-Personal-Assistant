...
def english_practice():
    ...
    while True:
        ...
        my_obj.save("practice_english/audio.mp3")
        ...
        time.sleep(1)
        playsound('practice_english/audio.mp3')
        print("...")
        print('The meaning of the word : ' + synset[0].definition())
        print()
        time.sleep(1)

        os.remove('practice_english/audio.mp3')
    ...
    correct.to_csv('practice_english/result/correct.csv', index=False)
    incorrect.to_csv('practice_english/result/incorrect.csv', index=False)
