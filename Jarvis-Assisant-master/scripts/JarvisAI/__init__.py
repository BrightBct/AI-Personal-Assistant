...
try:
    ...
    from features.weather import weather as wea
    ...
    from features.news import news as nw
    from features.tell_me_about import tell_me_about as tma
    from features.face_recognition import dataset_create as dc
    from features.face_recognition import train as train
    from features.face_recognition import predict as predict
    from features.face_recognition import face_reco as fr
    from features.show_me_my_images import show_me_my_images as my_photos
    from features.setup import setup as setup_assistant
    from features.google_photos import google_photos as gp
    from features.joke import joke
    from features.hot_word_detection import hot_word_detection as wake_word
    from features.mic_input_ai.mic_input_ai import SpeechRecognition as SpeechRecognitionAI
...
class JarvisAssistant:
    ...
    def send_mail(self, sender_email=None, sender_password=None, receiver_email=None, msg="Hello"):
        """
        This sum_function will send mail to user according to input params
    ...
    def tell_me_time(self):
        """
        This sum_function will return time
        :return: str/Bool
    ...
    def show_me_my_images(self):
        """
        This sum_function will show images from local directory. Make sure to run setup() first to setup local directory.
        :return: Bool
        """
    ...
    def show_google_photos(self):
        """
        This sum_function will open "https://photos.google.com/" in your browser.
        :return: Bool
        """
